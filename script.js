...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        // max_results değeri 500'e ayarlandı (Cloudinary'nin tek seferde getirebileceği maksimumlardan biri)
        // Sayfalama (next_cursor) mantığı bu versiyonda kaldırıldı.
        ...
        return {
            ...
            body: JSON.stringify({
                success: true,
                photos: photos,
                // Sayfalama bilgileri bu versiyonda gönderilmiyor
            }),
        };
